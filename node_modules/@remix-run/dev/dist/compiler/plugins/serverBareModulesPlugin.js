 ...
 */
function serverBareModulesPlugin(remixConfig, cwd, onWarning) {
      ...
      build.onResolve({
        ...
        pkgManager === "npm" || pkgManager === "yarn" && process.versions.pnp == null)) {
          try {
            ...
            onWarning(`The path "${path$1}" is imported in ` + `${path.relative(cwd, importer)} but ` + `"${path$1}" was not found in your node_modules. ` + `Did you forget to install it?`, path$1);
          }
        }
